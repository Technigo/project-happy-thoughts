...
const AllForm = () => {
  ...
  const onThoughtLikeChange = (_id) => {
    ...
    fetch(`https://project-happy-thoughts-api-thr246hagq-lz.a.run.app/thoughts/${_id}/heart` /* 'https://project-happy-thoughts-api-thr246hagq-lz.a.run.app/thoughts/:_id/heart' */, option) // _id is the key in API
      .then((res) => res.json())
