...
export const HeartButtons = ({ id, hearts, theme }) => {
  ...
  return (
    <div className="heart-container">
      <button
        onClick={clickLike}
        className={like > 0 ? "heart-button-like" : "heart-button-no-like"}
      >
      ...
      <div className="all-likes">
        ...
        <span className="your-likes">
          you liked this: x {yourPreviousLikes}
        </span>
      </div>
    </div>
  );
